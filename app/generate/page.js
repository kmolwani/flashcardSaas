// This page genertes the flaashcards
'use client'
  ...
  return(
    <Container maxWidth='md'>
      ...
      <SignedIn>
        ...
        {flashcards.length > 0 && (
          <Box sx={{mt:4}}>
            <Typography variant="h5" textAlign='center'>FlashCard Preview</Typography>
        ...
        <Dialog open={open} onClose={handleClose}>
          ...
          <DialogContent>
            <DialogContentText>
              Please enter a name for your flaashcards collection.
            </DialogContentText>
            <TextField 
              autoFocus 
              margin="dense" 
        ...
        {loading && !flashcards.length && ( // Show loading indicator only when fetching data and no flashcards yet
